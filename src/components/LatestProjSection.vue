    ...
    <section class="text-white mt-20" id="projects">
        <div class="px-4 xl:pl-16">
            <div class="mb-4 md:flex md:justify-between xl:pr-16">
                <h2 class="text-4xl font-bold text-white">Featured Projects by Madhvi Asthana</h2>
                <div class="flex space-x-4 mb-4 mt-5 md:mt-0">
                    <button class="hover:text-primary" 
                            v-for="category in ['all', 'Web Development', 'Full-Stack Applications', 'Data Analysis']"
                            :key="category" 
...
const Projects = ref([
    {
        ...
        image: new URL('@/assets/netflix.jpeg', import.meta.url).href,
        title: 'Netflix Clone',
...

    {
        ...
        image: new URL('@/assets/portfolio.jpeg', import.meta.url).href,
    ...
    },
    {
        ...
        image: new URL('@/assets/snapshot dashboard.png', import.meta.url).href,
    ...
    },
    {
        ...
        image: new URL('@/assets/sensor.png', import.meta.url).href,
