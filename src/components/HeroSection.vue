<template>
        ...
        <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
          <div class="lg:py-6">
            ...
            <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
              A passionate Web Developer skilled in Vue.js, HTML, CSS, and responsive design. I focus on creating user-friendly web applications and continuously learning new technologies. Let’s build something amazing together!
            </p>
            <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
              ...
              >
                <div class="hover:scale-105 transition-all ease-in-out flex justify-center items-center relative">
                  ...
                  <a
                    href="https://drive.google.com/file/d/1eufkNkJKwD3nly8qtbvxmuJ7CElIRDFC/view?usp=sharing"
                    target="_blank"
  ...
  // Reactive variable to control lightbox visibility
