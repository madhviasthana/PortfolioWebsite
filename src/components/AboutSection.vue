        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">
                    Enthusiastic and detail-oriented web developer with expertise in Vue.js, Python, and AI.
                    Passionate about creating responsive, user-friendly applications, and continuously
                    enhancing my skills. Experienced in machine learning, data analysis, and UI/UX design.
                    Always eager to learn and innovate in dynamic environments.
                </p>
